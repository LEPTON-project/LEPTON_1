 ...
 * @version         $Id: uninstall.php 1792 2012-03-07 08:34:28Z creativecat $
 *
 */
...
if(file_exists(WB_PATH.'/modules/'.$file.'/uninstall.php')) {
	...
	if (file_exists($temp_css)) {
		echo "\n<link href=\"". (WB_PATH.'/modules/'.$file.'/backend.css') ." rel=\"stylesheet\" type=\"text/css\" media=\"screen, projection\" />\n";
	} else {
		$temp_css = WB_PATH.'/modules/'.$file.'/css/backend.css';
		if (file_exists($temp_css)) {
			echo "\n<link href=\"". (WB_PATH.'/modules/'.$file.'/css/backend.css') ." rel=\"stylesheet\" type=\"text/css\" media=\"screen, projection\" />\n";
		}
	}
