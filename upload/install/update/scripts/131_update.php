...
echo '<h3>Current process : updating to LEPTON 1.3.1</h3>';
...
$database->query('UPDATE `' . TABLE_PREFIX . 'settings` SET `value` =\'1.3.1\' WHERE `name` =\'lepton_version\'');

/**
 *  success message
 */
echo "<h3>update to LEPTON 1.3.1 successfull!</h3><br /><hr /><br />";
